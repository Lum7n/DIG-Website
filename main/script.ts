namespace DIG_main {
    ...
    function addContentToHeader(screenType: string): void {
        ...
        if (screenType == "vertical") {
            ...
            let mainNavUl: HTMLUListElement = document.createElement("ul");
            ...
            //Navigation        
            // let navUList: HTMLUListElement = document.createElement("ul");
    ...
    function navigationUl(mainNavUl: HTMLUListElement): HTMLUListElement {
